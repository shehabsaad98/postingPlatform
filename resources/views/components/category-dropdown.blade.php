<x-dropdown>
    ...
    <x-dropdown-item href="/?{{ http_build_query(request()->except('hatlycategory', 'page')) }}" :active="request()->routeIs('home')">All
    </x-dropdown-item>

    @foreach ($categories as $category)
        <x-dropdown-item
            href="/?hatlycategory={{ $category->slug }}&{{ http_build_query(request()->except('hatlycategory', 'page')) }}"
